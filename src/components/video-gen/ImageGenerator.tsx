...
export function ImageGenerator({ prompt: initialPrompt, onImageGenerated }: ImageGeneratorProps) {
  ...
  return (
    <div className="mb-4 space-y-3">
      <div>
        <label className="text-xs text-gray-600 mb-1 block font-medium">Image Prompt</label>
        <div className="relative">
          <input
            ...
            className="w-full bg-white border border-gray-300 rounded-lg pl-3 pr-10 py-2 text-sm text-gray-800 outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
          />
          <button
      ...
      <div className="flex justify-between items-end">
        <div className="flex-1 mr-4">
          <label className="text-xs text-gray-600 mb-1 block font-medium">Optional Reference Image</label>
          {!referenceImage ? (
            <div
            ...
            <div className="relative h-12 w-full bg-gray-100 rounded-lg overflow-hidden border border-gray-300 flex items-center justify-between px-2">
        ...
        <div className="flex flex-col items-end">
          <label className="text-xs text-gray-600 mb-1 block font-medium">Advisor Gender</label>
          <select
            value={gender}
            onChange={(e) => setGender(e.target.value as 'male' | 'female')}
            className="bg-white border border-gray-300 rounded-lg px-2 py-2 text-xs text-gray-800 outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 min-w-[100px]"
          >
