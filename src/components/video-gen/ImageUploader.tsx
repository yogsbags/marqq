    ...
    <div className="mb-8">
      ...
      {!image ? (
        <div
          ...
          className="border-2 border-dashed border-gray-300 rounded-xl p-8 flex flex-col items-center justify-center cursor-pointer hover:border-emerald-500/50 hover:bg-gray-50 transition-all group"
        >
          {isUploading ? (
            <Loader2 className="w-8 h-8 text-emerald-500 animate-spin mb-2" />
          ) : (
            <Upload className="w-8 h-8 text-gray-500 group-hover:text-emerald-500 mb-2 transition-colors" />
          )}
        ...
        <div className="space-y-4">
          <div className="relative w-full h-48 bg-gray-100 rounded-xl overflow-hidden border border-gray-300 group">
            <img
              src={image}
              alt="Reference"
          ...
          {isEditing && (
            <div className="bg-gray-50 rounded-xl p-4 border border-gray-200 animate-in fade-in slide-in-from-top-2">
              <label className="text-xs text-gray-600 mb-2 block font-medium">Edit Instruction</label>
