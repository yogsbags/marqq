                ...
                <>
                  ...
                  <div className="w-full max-w-xs mx-auto space-y-2">
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <span className={audioLevel > 5 ? 'text-emerald-400' : 'text-red-400'}>
                        {audioLevel > 5 ? '✓ Detecting sound' : '⚠ No sound detected'}
                      </span>
                    </div>
            ...
            {recordingTime < 5 && (
              <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-3">
                <p className="text-xs text-red-400">
                  ⚠️ Recording should be at least 5 seconds (10+ recommended) for good voice cloning quality.
                </p>
              </div>
            )}
