...
export function EnhancedBulkGenerator() {
  ...
  const getStatusColor = (status: WorkflowStage['status']) => {
    switch (status) {
      case 'idle': return 'text-gray-400 dark:text-gray-500'
      case 'running': return 'text-blue-500 dark:text-blue-400 animate-pulse'
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 mb-8 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-lg">
            Comprehensive AI-powered content creation with workflow automation
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 mb-8">
          ...
          <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border-2 border-gray-200 dark:border-gray-600">
              ...
              <button
                ...
                className={`flex-1 px-4 py-3 rounded-lg font-semibold transition-all ${
                  executionMode === 'full'
                    ...
                    : 'bg-white dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 hover:border-blue-300 dark:hover:border-blue-500'
              ...
              <button
                ...
                className={`flex-1 px-4 py-3 rounded-lg font-semibold transition-all ${
                  executionMode === 'staged'
                    ...
                    : 'bg-white dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 hover:border-purple-300 dark:hover:border-purple-500'
                } disabled:opacity-50 disabled:cursor-not-allowed`}
              >
                <div className="flex items-center justify-center gap-2">
                  <span>🎯</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              <select
                ...
                disabled={isRunning || executingStage !== null}
                className="w-full px-4 py-2 border-2 border-gray-300 dark:border-gray-600 rounded-lg focus:border-blue-500 dark:focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-800 font-medium bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 disabled:bg-gray-100 dark:disabled:bg-gray-800 disabled:cursor-not-allowed transition-colors"
              >
                {categories.map(cat => (
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border-2 border-gray-300 dark:border-gray-600 rounded-lg focus:border-blue-500 dark:focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-800 font-medium bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 disabled:bg-gray-100 dark:disabled:bg-gray-800 disabled:cursor-not-allowed transition-colors placeholder:text-gray-400 dark:placeholder:text-gray-500"
              />
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
...
Key takeaways`}
                rows={12}
                className="w-full px-4 py-2 border-2 border-gray-300 dark:border-gray-600 rounded-lg focus:border-blue-500 dark:focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-800 font-mono text-sm bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 disabled:bg-gray-100 dark:disabled:bg-gray-800 disabled:cursor-not-allowed transition-colors placeholder:text-gray-400 dark:placeholder:text-gray-500 resize-y"
              />
              <div className="flex items-start gap-2 mt-2">
                ...
                <div className="text-xs text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-700 px-3 py-2 rounded border border-gray-200 dark:border-gray-600 whitespace-nowrap flex-shrink-0">
                  {contentOutline.split('\n').length} lines • {contentOutline.length.toLocaleString()} chars
                </div>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="w-8 h-8 rounded bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 disabled:bg-gray-100 dark:disabled:bg-gray-800 disabled:cursor-not-allowed font-bold text-gray-700 dark:text-gray-200 transition-colors"
                >
                  −
                </button>
                <input
                  ...
                  min="1"
                  max="50"
                  className="w-20 px-2 py-2 text-center border-2 border-gray-300 dark:border-gray-600 rounded-lg focus:border-blue-500 dark:focus:border-blue-400 focus:outline-none font-semibold bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 disabled:bg-gray-100 dark:disabled:bg-gray-800"
                />
                <button
          ...
          <div className="flex items-center justify-between mb-6">
              ...
              <button
                ...
                className={`px-8 py-4 rounded-lg font-semibold text-lg transition-all transform hover:scale-105 ${
                  isRunning || executingStage !== null
                    ...
                    : 'bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 hover:from-blue-600 hover:to-blue-700 dark:hover:from-blue-700 dark:hover:to-blue-800 text-white shadow-lg hover:shadow-xl'
                }`}
              >
                {isRunning ? (
            ...
            {/* Staged Mode Info */}
            {executionMode === 'staged' && (
              <div className="text-sm text-gray-600 dark:text-gray-300 bg-purple-50 dark:bg-purple-900/30 px-4 py-3 rounded-lg border-2 border-purple-200 dark:border-purple-700">
                <p className="font-semibold text-purple-700 dark:text-purple-400">Stage-by-Stage Mode Active</p>
                <p className="text-xs mt-1 dark:text-gray-400">Execute and review each stage individually below</p>
              </div>
            )}
          </div>
            ...
            {stages.map((stage) => (
              ...
              >
                <div className="p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3 flex-1">
                      ...
                      <div className="flex-1">
                        <h3 className="font-semibold text-gray-800 dark:text-gray-100">{stage.name}</h3>
                        {stage.message && (
                          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">{stage.message}</p>
                        )}
                ...
                {expandedStage === stage.id && stageData[stage.id]?.data && stageData[stage.id]?.summary && (
                  <div className="border-t-2 border-green-200 dark:border-green-700 p-4 bg-white dark:bg-gray-800">
                    ...
                    <div className="overflow-x-auto">
                      <div className="max-h-96 overflow-y-auto">
                        {stageData[stage.id].data.map((row: any, idx: number) => (
                          <div key={idx} className="mb-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded border border-gray-200 dark:border-gray-600 text-xs relative">
                            {/* Edit Button */}
                            <button
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <div className="bg-gray-900 dark:bg-gray-950 rounded-lg p-4 h-96 overflow-y-auto font-mono text-sm">
            {logs.length === 0 ? (
              <p className="text-gray-500 dark:text-gray-400 italic">Waiting for workflow execution...</p>
            ) : (
              logs.map((log, index) => (
                <div key={index} className="text-green-400 dark:text-green-500 mb-1">
                  {log}
                </div>
              ))
            )}
