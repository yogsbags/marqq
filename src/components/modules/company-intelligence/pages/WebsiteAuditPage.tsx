    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="p-4">
          ...
          <div className="text-xs text-gray-600 mt-1">Can users understand “what you do” fast?</div>
        </Card>
        <Card className="p-4">
          ...
          <div className="text-xs text-gray-600 mt-1">Signals: compliance, proof, credibility.</div>
        </Card>
        <Card className="p-4">
          ...
          <div className="text-xs text-gray-600 mt-1">Is attention guided to the CTA?</div>
        </Card>
      </div>
            ...
            sections.map((s, idx) => (
              <div key={idx} className="border rounded-md p-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-2 text-sm">
                  <div>
                    <div className="text-xs text-gray-600 mb-1">What works</div>
            ...
            {plan.length ? (
              plan.slice(0, 10).map((p, idx) => (
                <div key={idx} className="border rounded-md p-3">
                  ...
                  <div className="text-sm text-gray-800 mt-1">{String(p.why || '')}</div>
          ...
          <CardContent className="space-y-3 text-sm">
            {experiments.slice(0, 10).map((e, idx) => (
              <div key={idx} className="border rounded-md p-3">
                ...
                <div className="text-xs text-gray-700 mt-1">Hypothesis: {String(e.hypothesis || '—')}</div>
                <div className="text-xs text-gray-700 mt-1">Success metric: {String(e.successMetric || '—')}</div>
