...
export async function POST(req: NextRequest) {
  try {
    ...
    // Read and parse CSV (same options as projects/enhanced-bulk-generator/frontend)
    ...
    // Convert back to CSV — quote all fields so commas/semicolons inside values don't split columns
