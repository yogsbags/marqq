...
- [x] **VEENA-03**: Veena triggers `new_company_onboarded` signal → fires full-chain onboarding (sequential: veena → isha → neel → zara)
...
| VEENA-03 | Phase 3 — Veena (Company Intelligence) | Complete |
