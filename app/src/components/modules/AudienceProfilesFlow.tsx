          ...
          <CardContent className="space-y-6 p-8 lg:p-10">
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              ...
              <div className="rounded-[1.4rem] border border-orange-400/15 bg-white/5 p-4">
                ...
                <div className="text-xs uppercase tracking-[0.22em] text-orange-100/45">Buyer layer</div>
                <div className="mt-2 text-sm font-medium text-orange-50">{formatLabel(buyer)}</div>
              </div>
              <div className="rounded-[1.4rem] border border-orange-400/15 bg-white/5 p-4">
                <div className="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-xl bg-orange-500/12 text-orange-200">
                  <TargetIcon className="h-4 w-4" />
                </div>
                <div className="text-xs uppercase tracking-[0.22em] text-orange-100/45">Use</div>
